...
public struct AABB
{
    ...
    public float MinX => System.MathF.Min(p0.x,p1.x);
    public float MinY => System.MathF.Min(p0.y,p1.y);
    public float MaxX => System.MathF.Max(p0.x,p1.x);
    public float MaxY => System.MathF.Max(p0.y,p1.y);
